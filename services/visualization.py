...
class VisualizationManager:
    ...
    async def generate_visualization(self, question: str, results: List[Dict], sql: str) -> Optional[Dict]:
        ...
        try:
            ...
            5. If there is a "Year" column, use it as clean integers (2024, 2025), not decimals (2024.0) 
            6. Always use "Year" column in X-axis  
            7. Make the chart readable with proper scientific notation (K, M, B)

            Chart Type Rules:
            - Use 'bar' for comparisons between categories
            - Use 'line' for trends over time  and year-over-year trends
